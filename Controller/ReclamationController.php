  ...
  /* #[Route('/repondrereclamation/{id}', name: 'reponse')]
    ...
    public function searchReclamationx(Request $request,NormalizerInterface $Normalizer,ReclamationRepository $sr)
    {
            ...
            $requestString=$request->get('searchValue');
             $reclamations=$sr->findReclamationByType($requestString);
    ...
    #[Route('/indexSortedByDate', name: 'indexSortedByDate')]
    public function indexSortedByDate(ReclamationRepository $reclamationRepository): Response
    {
        $reclamations=$reclamationRepository->findAllSortedByDateAsc();
    ...
    #[Route('/searchReclamationt/{val}', name: 'searchReclamationt')]

    public function searchReclamationT(Request $request,NormalizerInterface $Normalizer,ReclamationRepository $sr ,$val)
    {
            //$repository = $this->getDoctrine()->getRepository(Reclamation::class);
            //$requestString=$request->get('searchValue');
             $reclamations=$sr->findReclamationByTraite($val);
    ...
    public function chartAction()
{
    ...
    return $this->render('reclamation/chart.html.twig', array(
        'data' => $data , 'reclamations' => $reclamations
    ));
}
